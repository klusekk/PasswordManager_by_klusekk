...
SECRET_KEY = 'django-insecure-s92&86e#55@e^du*7ktfb5dc^5+d39_n6=-*gyl0bp@gsm#+ne'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'my_app.context_processors.version_context',  # Dodaj ten context processor
            ],
        },
    },
]
...
AUTH_USER_MODEL = 'my_app.MyAppUser'
